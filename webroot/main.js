...
var components_2 = __webpack_require__(6);
var React = __webpack_require__(1);
var App = /** @class */function (_super) {
    ...
    App.prototype.render = function () {
        return React.createElement(components_2.SupportCheck, null, React.createElement(components_1.PeerWindow, null), React.createElement(components_1.ChatFeed, null));
    };
    return App;
}(React.Component);
exports.App = App;
...
var ChatFeedComponent = /** @class */function (_super) {
    __extends(ChatFeedComponent, _super);
    function ChatFeedComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ChatFeedComponent.prototype.render = function () {
        return React.createElement("div", { style: feedContainerStyle }, React.createElement("div", { style: feedStyle }, this.props.messages.map(function (message, index) {
            return React.createElement("div", { key: index }, React.createElement("div", { style: chatContainerStyle }, React.createElement("div", null, message.body), React.createElement("div", { style: chatUserStyle }, message.source.displayName), React.createElement("div", { style: chatTimeStyle }, message.timestamp.toLocaleTimeString())));
        })), React.createElement(_1.ChatWindow, null));
    };
...
exports.ChatFeed = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(ChatFeedComponent);
...
;
;
var ChatWindowComponent = /** @class */function (_super) {
    __extends(ChatWindowComponent, _super);
    function ChatWindowComponent(props) {
    ...
    ChatWindowComponent.prototype.render = function () {
        return React.createElement("div", { style: chatContainerStyle }, React.createElement("div", { style: { float: "left", width: "calc(100% - 36px)", height: "100%" } }, React.createElement("input", { type: "text", style: chatContainerInputStyle, placeholder: "Type a message.", value: this.state.message, onKeyDown: this.handleMessageOnKeydown.bind(this), onChange: this.handleMessageOnChange.bind(this) })), React.createElement("div", { style: chatSendIconStyle, onClick: this.handleOnSend.bind(this) }));
    };
    ChatWindowComponent.prototype.handleOnSend = function () {
        this.props.onMessageSend(this.state.message);
        this.setState({ message: "" });
    };
    ChatWindowComponent.prototype.handleMessageOnChange = function (event) {
        this.setState({ message: event.target.value });
    };
    ChatWindowComponent.prototype.handleMessageOnKeydown = function (event) {
...
exports.ChatWindow = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(ChatWindowComponent);
...
var PeerDisplay = /** @class */function (_super) {
    __extends(PeerDisplay, _super);
    function PeerDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PeerDisplay.prototype.render = function () {
        return React.createElement("div", { style: peerStyle }, React.createElement("img", { style: userIconStyle, src: userIcon }), React.createElement("span", { style: peerNameStyle }, this.props.peer ? this.props.peer.displayName : ""));
    };
    return PeerDisplay;
}(React.PureComponent);
...
var PeerWindowComponent = /** @class */function (_super) {
    __extends(PeerWindowComponent, _super);
    function PeerWindowComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PeerWindowComponent.prototype.render = function () {
        return React.createElement("div", { style: peerContainerStyle, className: "background" }, React.createElement("h1", { style: { textAlign: "center", color: "#EB0000", margin: 0, padding: 0 } }, "Swarmr"), React.createElement(_1.PeerDisplay, { peer: this.props.local }), this.props.peers.map(function (peer, index) {
            return React.createElement(_1.PeerDisplay, { key: index, peer: peer });
        }));
    };
    return PeerWindowComponent;
}(React.PureComponent);
var mapStateToProps = function mapStateToProps(state, ownProps) {
    return {
        peers: state.peers,
...
exports.PeerWindow = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(PeerWindowComponent);
...
Object.defineProperty(exports, "__esModule", { value: true });
var models_1 = __webpack_require__(10);
var peerFactory_1 = __webpack_require__(88);
...
Object.defineProperty(exports, "__esModule", { value: true });
var peerConnection_1 = __webpack_require__(89);
var models_1 = __webpack_require__(10);
var PeerFactory = /** @class */function () {
    ...
    PeerFactory.prototype.handleOnClose = function (id) {
...
var PeerConnection = /** @class */function () {
    ...
    PeerConnection.prototype.createOffer = function () {
        ...
        this.rtcConnection.createOffer().then(function (description) {
            return _this.setLocalDescription(description);
        });
    };
    PeerConnection.prototype.addIceCandidate = function (body) {
        this.rtcConnection.addIceCandidate(new RTCIceCandidate(body));
    };
    PeerConnection.prototype.addRemoteDescription = function (body) {
        var peer = this;
        this.rtcConnection.setRemoteDescription(new RTCSessionDescription(body)).then(function () {
